...
import { Box, RotateCw, ZoomIn, Wifi } from "lucide-react"

interface ESP323DViewerProps {
...
export function ESP323DViewer({
  ...
  return (
    <section className={compact ? "" : "border-b border-border bg-gradient-to-br from-blue-500/5 to-transparent"}>
          ...
          <div className="mt-6 grid gap-4 sm:grid-cols-3">
            <Card className="p-4 bg-blue-500/5 border-blue-500/20">
              <div className="flex items-center gap-3 mb-2">
                ...
                <h3 className="font-semibold text-sm">IoT Ready</h3>
              </div>
              <p className="text-xs text-muted-foreground">
                Understand WiFi/Bluetooth components and connectivity options
              </p>
            </Card>
            ...
            <Card className="p-4 bg-green-500/5 border-green-500/20">
              ...
              <p className="text-xs text-muted-foreground">
                Rotate and zoom to explore pin layout and module design
              </p>
            </Card>
            ...
            <Card className="p-4 bg-purple-500/5 border-purple-500/20">
              <div className="flex items-center gap-3 mb-2">
                ...
                <h3 className="font-semibold text-sm">Virtual Testing</h3>
              </div>
              <p className="text-xs text-muted-foreground">
                Test WiFi/BT projects virtually in our Studio before deployment
              </p>
            </Card>
          </div>
        )}
